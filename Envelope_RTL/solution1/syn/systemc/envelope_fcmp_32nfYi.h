...
#ifndef __envelope_fcmp_32nfYi__HH__
#define __envelope_fcmp_32nfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(envelope_fcmp_32nfYi) {
    ...
    SC_CTOR(envelope_fcmp_32nfYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
