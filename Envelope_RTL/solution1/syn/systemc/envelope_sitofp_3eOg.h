...
#ifndef __envelope_sitofp_3eOg__HH__
#define __envelope_sitofp_3eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(envelope_sitofp_3eOg) {
    ...
    SC_CTOR(envelope_sitofp_3eOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
