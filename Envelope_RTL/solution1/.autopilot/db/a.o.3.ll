...
define void @envelope(float* %wave_in_V, float* %wave_out_V, i32 %press, i32 %attackDuration, i32 %decayDuration, i32 %sustainAmplitude, i32 %sustainDuration, i32 %releaseDuration) {
  ...
  %releaseDuration_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %releaseDuration) ; [#uses=3 type=i32]
  ...
  %sustainDuration_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %sustainDuration) ; [#uses=3 type=i32]
  ...
  %decayDuration_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %decayDuration) ; [#uses=3 type=i32]
...
._crit_edge:                                      ; preds = %codeRepl1, %0
  ...
  br i1 %guard_variable_for_e_1, label %._crit_edge6, label %codeRepl, !dbg !152 ; [debug line = 36:90]
...
._crit_edge6:                                     ; preds = %codeRepl, %._crit_edge
  ...
  br i1 %guard_variable_for_e_2, label %._crit_edge7, label %codeRepl2, !dbg !153 ; [debug line = 37:91]
...
._crit_edge7:                                     ; preds = %codeRepl2, %._crit_edge6
  ...
  %releaseTime_load = load i32* @releaseTime, align 4, !dbg !154 ; [#uses=1 type=i32] [debug line = 52:3]
  br i1 %guard_variable_for_e_3, label %._crit_edge8, label %codeRepl3, !dbg !156 ; [debug line = 41:42]
...
._crit_edge8:                                     ; preds = %codeRepl3, %._crit_edge7
  %releaseTime_flag = phi i1 [ true, %codeRepl3 ], [ false, %._crit_edge7 ] ; [#uses=1 type=i1]
  %releaseTime_loc = phi i32 [ %releaseDuration_read, %codeRepl3 ], [ %releaseTime_load, %._crit_edge7 ] ; [#uses=2 type=i32]
  %guard_variable_for_e_4 = load i1* @guard_variable_for_e, align 1 ; [#uses=1 type=i1]
  %sustainTime_load = load i32* @sustainTime, align 4, !dbg !157 ; [#uses=1 type=i32] [debug line = 51:3]
  br i1 %guard_variable_for_e_4, label %._crit_edge9_ifconv, label %codeRepl4, !dbg !158 ; [debug line = 42:42]
...
._crit_edge9_ifconv:                              ; preds = %codeRepl4, %._crit_edge8
  %sustainTime_flag = phi i1 [ true, %codeRepl4 ], [ false, %._crit_edge8 ] ; [#uses=1 type=i1]
  %sustainTime_loc = phi i32 [ %sustainDuration_read, %codeRepl4 ], [ %sustainTime_load, %._crit_edge8 ] ; [#uses=2 type=i32]
  ...
  %tmp_22 = call float @_ssdm_op_Read.axis.volatile.floatP(float* %wave_in_V), !dbg !172 ; [#uses=4 type=float] [debug line = 125:9@102:9@45:2]
  call void @llvm.dbg.value(metadata !{float %tmp_22}, i64 0, metadata !174), !dbg !172 ; [debug line = 125:9@102:9@45:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %tmp_22}, i64 0, metadata !175), !dbg !176 ; [debug line = 126:9@102:9@45:2] [debug variable = resultAmplitude]
  %wait_load = load i1* @wait, align 1            ; [#uses=1 type=i1]
  %not_tmp_4 = icmp ne i32 %press_read, 0, !dbg !177 ; [#uses=2 type=i1] [debug line = 47:2]
  %tmp_5 = icmp sgt i32 %press_read, 0, !dbg !178 ; [#uses=1 type=i1] [debug line = 50:2]
  %time_load = load i32* @time, align 4, !dbg !178 ; [#uses=2 type=i32] [debug line = 50:2]
  %tmp_6 = icmp sgt i32 %time_load, %decayDuration_read, !dbg !178 ; [#uses=1 type=i1] [debug line = 50:2]
  %or_cond_2 = and i1 %tmp_5, %tmp_6, !dbg !178   ; [#uses=6 type=i1] [debug line = 50:2]
  %tmp_7 = add nsw i32 %sustainTime_loc, 1, !dbg !157 ; [#uses=2 type=i32] [debug line = 51:3]
  %tmp_8 = add nsw i32 %releaseTime_loc, 1, !dbg !154 ; [#uses=2 type=i32] [debug line = 52:3]
  %releaseTime_flag_1 = or i1 %or_cond_2, %releaseTime_flag ; [#uses=1 type=i1]
  %releaseTime_new_1 = select i1 %or_cond_2, i32 %tmp_8, i32 %releaseDuration_read ; [#uses=1 type=i32]
  %releaseTime_loc_1 = select i1 %or_cond_2, i32 %tmp_8, i32 %releaseTime_loc ; [#uses=1 type=i32]
  %sustainTime_flag_1 = or i1 %or_cond_2, %sustainTime_flag ; [#uses=1 type=i1]
  %sustainTime_new_1 = select i1 %or_cond_2, i32 %tmp_7, i32 %sustainDuration_read ; [#uses=1 type=i32]
  %sustainTime_loc_1 = select i1 %or_cond_2, i32 %tmp_7, i32 %sustainTime_loc ; [#uses=2 type=i32]
  %tmp_4 = xor i1 %wait_load, true, !dbg !179     ; [#uses=1 type=i1] [debug line = 55:2]
  %tmp_s = or i1 %not_tmp_4, %tmp_4, !dbg !179    ; [#uses=1 type=i1] [debug line = 55:2]
  %time_load_s = select i1 %tmp_s, i32 %time_load, i32 0, !dbg !179 ; [#uses=8 type=i32] [debug line = 55:2]
  %tmp_1 = icmp slt i32 %time_load_s, %attackDuration_read, !dbg !180 ; [#uses=4 type=i1] [debug line = 59:2]
...
._crit_edge11.new_ifconv:                         ; preds = %._crit_edge11.new6, %mergeST
  %attackSlope_load = load float* @attackSlope, align 4, !dbg !181 ; [#uses=1 type=float] [debug line = 60:3]
  %tmp_2 = sitofp i32 %time_load_s to float, !dbg !181 ; [#uses=1 type=float] [debug line = 60:3]
  %tmp_3 = fmul float %attackSlope_load, %tmp_2, !dbg !181 ; [#uses=1 type=float] [debug line = 60:3]
  %resultAmplitude_1 = fmul float %tmp_22, %tmp_3, !dbg !181 ; [#uses=1 type=float] [debug line = 60:3]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_1}, i64 0, metadata !175), !dbg !181 ; [debug line = 60:3] [debug variable = resultAmplitude]
  %tmp_9 = icmp slt i32 %time_load_s, %decayDuration_read, !dbg !183 ; [#uses=2 type=i1] [debug line = 63:7]
  %decaySlope_load = load float* @decaySlope, align 4, !dbg !184 ; [#uses=1 type=float] [debug line = 64:3]
  %tmp_10 = sub nsw i32 %time_load_s, %attackDuration_read, !dbg !184 ; [#uses=1 type=i32] [debug line = 64:3]
  %tmp_11 = sitofp i32 %tmp_10 to float, !dbg !184 ; [#uses=1 type=float] [debug line = 64:3]
  %tmp_12 = fmul float %decaySlope_load, %tmp_11, !dbg !184 ; [#uses=1 type=float] [debug line = 64:3]
  %tmp_13 = fadd float %tmp_12, 2.000000e+00, !dbg !184 ; [#uses=1 type=float] [debug line = 64:3]
  %resultAmplitude_2 = fmul float %tmp_22, %tmp_13, !dbg !184 ; [#uses=1 type=float] [debug line = 64:3]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_2}, i64 0, metadata !175), !dbg !184 ; [debug line = 64:3] [debug variable = resultAmplitude]
  %tmp_14 = icmp slt i32 %time_load_s, %sustainTime_loc_1, !dbg !186 ; [#uses=3 type=i1] [debug line = 67:7]
  %tmp_15 = sitofp i32 %sustainAmplitude_rea to float, !dbg !187 ; [#uses=2 type=float] [debug line = 68:3]
  %resultAmplitude_3 = fmul float %tmp_22, %tmp_15, !dbg !187 ; [#uses=1 type=float] [debug line = 68:3]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_3}, i64 0, metadata !175), !dbg !187 ; [debug line = 68:3] [debug variable = resultAmplitude]
  %tmp_16 = icmp slt i32 %time_load_s, %releaseTime_loc_1, !dbg !189 ; [#uses=2 type=i1] [debug line = 71:7]
  %releaseSlope_load = load float* @releaseSlope, align 4, !dbg !190 ; [#uses=1 type=float] [debug line = 72:3]
  %tmp_17 = sub nsw i32 %time_load_s, %sustainTime_loc_1, !dbg !190 ; [#uses=1 type=i32] [debug line = 72:3]
  %tmp_18 = sitofp i32 %tmp_17 to float, !dbg !190 ; [#uses=1 type=float] [debug line = 72:3]
  %tmp_19 = fmul float %releaseSlope_load, %tmp_18, !dbg !190 ; [#uses=1 type=float] [debug line = 72:3]
  %tmp_20 = fadd float %tmp_19, %tmp_15, !dbg !190 ; [#uses=1 type=float] [debug line = 72:3]
  %resultAmplitude_4 = fmul float %tmp_22, %tmp_20, !dbg !190 ; [#uses=1 type=float] [debug line = 72:3]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_4}, i64 0, metadata !175), !dbg !190 ; [debug line = 72:3] [debug variable = resultAmplitude]
  ...
  %tmp_19_not = xor i1 %tmp_14, true              ; [#uses=1 type=i1]
  ...
  %tmp_21_not = xor i1 %tmp_16, true              ; [#uses=1 type=i1]
  %not_sel_tmp = or i1 %sel_tmp13_demorgan, %tmp_21_not ; [#uses=1 type=i1]
  %tmp1 = and i1 %not_sel_tmp7, %not_sel_tmp      ; [#uses=1 type=i1]
  %sel_tmp8 = and i1 %tmp1, %sel_tmp              ; [#uses=1 type=i1]
  %wait_flag_1 = or i1 %not_tmp_4, %sel_tmp8      ; [#uses=1 type=i1]
  ...
  %sel_tmp5 = and i1 %tmp_16, %sel_tmp4           ; [#uses=2 type=i1]
  ...
  %resultAmplitude_5 = select i1 %tmp_1, float %resultAmplitude_1, float 0.000000e+00, !dbg !192 ; [#uses=1 type=float] [debug line = 145:31@106:9@82:2]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_5}, i64 0, metadata !175), !dbg !184 ; [debug line = 64:3] [debug variable = resultAmplitude]
  %resultAmplitude_6 = select i1 %sel_tmp2, float %resultAmplitude_2, float %resultAmplitude_5, !dbg !192 ; [#uses=1 type=float] [debug line = 145:31@106:9@82:2]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_6}, i64 0, metadata !175), !dbg !184 ; [debug line = 64:3] [debug variable = resultAmplitude]
  %resultAmplitude_7 = select i1 %sel_tmp3, float %resultAmplitude_3, float %resultAmplitude_6, !dbg !192 ; [#uses=1 type=float] [debug line = 145:31@106:9@82:2]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_7}, i64 0, metadata !175), !dbg !184 ; [debug line = 64:3] [debug variable = resultAmplitude]
  %resultAmplitude = select i1 %sel_tmp5, float %resultAmplitude_4, float %resultAmplitude_7, !dbg !192 ; [#uses=1 type=float] [debug line = 145:31@106:9@82:2]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude}, i64 0, metadata !175), !dbg !184 ; [debug line = 64:3] [debug variable = resultAmplitude]
  %tmp_21 = add nsw i32 %time_load_s, 1, !dbg !199 ; [#uses=1 type=i32] [debug line = 80:2]
  store i32 %tmp_21, i32* @time, align 4, !dbg !199 ; [debug line = 80:2]
  call void @llvm.dbg.value(metadata !{float* %wave_out_V}, i64 0, metadata !200), !dbg !202 ; [debug line = 105:48@82:2] [debug variable = stream<float>.V]
  call void @llvm.dbg.value(metadata !{float* %wave_out_V}, i64 0, metadata !203), !dbg !205 ; [debug line = 144:48@106:9@82:2] [debug variable = stream<float>.V]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude}, i64 0, metadata !206), !dbg !192 ; [debug line = 145:31@106:9@82:2] [debug variable = tmp]
  call void @_ssdm_op_Write.axis.volatile.floatP(float* %wave_out_V, float %resultAmplitude), !dbg !207 ; [debug line = 146:9@106:9@82:2]
...
mergeST7:                                         ; preds = %._crit_edge11.new_ifconv
  store i1 %not_or_cond, i1* @wait, align 1, !dbg !208 ; [debug line = 48:3]
  br label %.new

.new:                                             ; preds = %mergeST7, %._crit_edge11.new_ifconv
  ret void, !dbg !209                             ; [debug line = 83:1]
}
...
!154 = metadata !{i32 52, i32 3, metadata !155, null}
!155 = metadata !{i32 786443, metadata !142, i32 50, i32 40, metadata !58, i32 1} ; [ DW_TAG_lexical_block ]
!156 = metadata !{i32 41, i32 42, metadata !142, null}
!157 = metadata !{i32 51, i32 3, metadata !155, null}
...
!178 = metadata !{i32 50, i32 2, metadata !142, null}
!179 = metadata !{i32 55, i32 2, metadata !142, null}
!180 = metadata !{i32 59, i32 2, metadata !142, null}
!181 = metadata !{i32 60, i32 3, metadata !182, null}
!182 = metadata !{i32 786443, metadata !142, i32 59, i32 27, metadata !58, i32 3} ; [ DW_TAG_lexical_block ]
!183 = metadata !{i32 63, i32 7, metadata !142, null}
!184 = metadata !{i32 64, i32 3, metadata !185, null}
!185 = metadata !{i32 786443, metadata !142, i32 63, i32 31, metadata !58, i32 4} ; [ DW_TAG_lexical_block ]
!186 = metadata !{i32 67, i32 7, metadata !142, null}
!187 = metadata !{i32 68, i32 3, metadata !188, null}
!188 = metadata !{i32 786443, metadata !142, i32 67, i32 30, metadata !58, i32 5} ; [ DW_TAG_lexical_block ]
!189 = metadata !{i32 71, i32 7, metadata !142, null}
!190 = metadata !{i32 72, i32 3, metadata !191, null}
!191 = metadata !{i32 786443, metadata !142, i32 71, i32 29, metadata !58, i32 6} ; [ DW_TAG_lexical_block ]
!192 = metadata !{i32 145, i32 31, metadata !193, metadata !195}
!193 = metadata !{i32 786443, metadata !194, i32 144, i32 79, metadata !64, i32 9} ; [ DW_TAG_lexical_block ]
!194 = metadata !{i32 786478, i32 0, metadata !63, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamIfE5writeERKf", metadata !64, i32 144, metadata !93, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !110, metadata !72, i32 144} ; [ DW_TAG_subprogram ]
!195 = metadata !{i32 106, i32 9, metadata !196, metadata !198}
!196 = metadata !{i32 786443, metadata !197, i32 105, i32 88, metadata !64, i32 8} ; [ DW_TAG_lexical_block ]
!197 = metadata !{i32 786478, i32 0, metadata !63, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls6streamIfElsERKf", metadata !64, i32 105, metadata !93, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !92, metadata !72, i32 105} ; [ DW_TAG_subprogram ]
!198 = metadata !{i32 82, i32 2, metadata !142, null}
!199 = metadata !{i32 80, i32 2, metadata !142, null}
!200 = metadata !{i32 790531, metadata !201, metadata !"stream<float>.V", null, i32 105, metadata !163, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!201 = metadata !{i32 786689, metadata !197, metadata !"this", metadata !64, i32 16777321, metadata !162, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!202 = metadata !{i32 105, i32 48, metadata !197, metadata !198}
!203 = metadata !{i32 790531, metadata !204, metadata !"stream<float>.V", null, i32 144, metadata !163, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!204 = metadata !{i32 786689, metadata !194, metadata !"this", metadata !64, i32 16777360, metadata !162, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!205 = metadata !{i32 144, i32 48, metadata !194, metadata !195}
!206 = metadata !{i32 786688, metadata !193, metadata !"tmp", metadata !64, i32 145, metadata !67, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!207 = metadata !{i32 146, i32 9, metadata !193, metadata !195}
!208 = metadata !{i32 48, i32 3, metadata !142, null}
!209 = metadata !{i32 83, i32 1, metadata !142, null}
