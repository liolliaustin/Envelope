...
._crit_edge_ifconv:
  ...
  %decayDuration_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %decayDuration) ; [#uses=4 type=i32]
  ...
  %press_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %press) ; [#uses=4 type=i32]
  ...
  %tmp_5_to_int = bitcast float %sustainAmplitude_rea to i32, !dbg !148 ; [#uses=3 type=i32] [debug line = 36:82]
  %tmp_5_neg = xor i32 %tmp_5_to_int, -2147483648, !dbg !148 ; [#uses=1 type=i32] [debug line = 36:82]
  %tmp_5 = bitcast i32 %tmp_5_neg to float, !dbg !148 ; [#uses=1 type=float] [debug line = 36:82]
  %tmp_6 = sub nsw i32 %releaseDuration_read, %decayDuration_read, !dbg !148 ; [#uses=1 type=i32] [debug line = 36:82]
  %tmp_7 = sitofp i32 %tmp_6 to float, !dbg !148  ; [#uses=1 type=float] [debug line = 36:82]
  %releaseSlope = fdiv float %tmp_5, %tmp_7, !dbg !148 ; [#uses=1 type=float] [debug line = 36:82]
  call void @llvm.dbg.value(metadata !{float %releaseSlope}, i64 0, metadata !149), !dbg !148 ; [debug line = 36:82] [debug variable = releaseSlope]
  %tmp_8 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %tmp_5_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp = trunc i32 %tmp_5_to_int to i23           ; [#uses=1 type=i23]
  %notlhs = icmp ne i8 %tmp_8, -1                 ; [#uses=1 type=i1]
  %notrhs = icmp eq i23 %tmp, 0                   ; [#uses=1 type=i1]
  %tmp_28 = or i1 %notrhs, %notlhs                ; [#uses=1 type=i1]
  %tmp_30 = fcmp ogt float %sustainAmplitude_rea, 1.000000e+00, !dbg !150 ; [#uses=1 type=i1] [debug line = 40:2]
  %tmp_31 = and i1 %tmp_28, %tmp_30, !dbg !150    ; [#uses=1 type=i1] [debug line = 40:2]
  %sustainAmplitude_ass = select i1 %tmp_31, float 1.000000e+00, float %sustainAmplitude_rea, !dbg !150 ; [#uses=2 type=float] [debug line = 40:2]
  call void @llvm.dbg.value(metadata !{float %sustainAmplitude_ass}, i64 0, metadata !118), !dbg !150 ; [debug line = 40:2] [debug variable = sustainAmplitude]
  %lastpress_load = load i32* @lastpress, align 4, !dbg !151 ; [#uses=1 type=i32] [debug line = 47:2]
  %tmp_9 = icmp ne i32 %lastpress_load, 0, !dbg !151 ; [#uses=1 type=i1] [debug line = 47:2]
  %tmp_s = icmp eq i32 %press_read, 0, !dbg !151  ; [#uses=5 type=i1] [debug line = 47:2]
  %or_cond_4 = or i1 %tmp_9, %tmp_s, !dbg !151    ; [#uses=2 type=i1] [debug line = 47:2]
  %releaseTime_load = load i32* @releaseTime, align 4, !dbg !152 ; [#uses=2 type=i32] [debug line = 62:3]
  %sustainTime_load = load i32* @sustainTime, align 4, !dbg !154 ; [#uses=2 type=i32] [debug line = 61:3]
  %tmp_10 = add nsw i32 1, %decayDuration_read, !dbg !155 ; [#uses=2 type=i32] [debug line = 49:3]
  %releaseTime_load_rel = select i1 %or_cond_4, i32 %releaseTime_load, i32 %releaseDuration_read, !dbg !151 ; [#uses=1 type=i32] [debug line = 47:2]
  %sustainTime_load_tmp = select i1 %or_cond_4, i32 %sustainTime_load, i32 %tmp_10, !dbg !151 ; [#uses=1 type=i32] [debug line = 47:2]
  store i32 %press_read, i32* @lastpress, align 4, !dbg !157 ; [debug line = 52:2]
  call void @llvm.dbg.value(metadata !{float* %wave_in_V}, i64 0, metadata !158), !dbg !163 ; [debug line = 101:48@57:2] [debug variable = stream<float>.V]
  call void @llvm.dbg.value(metadata !{float* %wave_in_V}, i64 0, metadata !165), !dbg !168 ; [debug line = 123:48@102:9@57:2] [debug variable = stream<float>.V]
  %tmp_38 = call float @_ssdm_op_Read.axis.volatile.floatP(float* %wave_in_V), !dbg !171 ; [#uses=4 type=float] [debug line = 125:9@102:9@57:2]
  call void @llvm.dbg.value(metadata !{float %tmp_38}, i64 0, metadata !173), !dbg !171 ; [debug line = 125:9@102:9@57:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{float %tmp_38}, i64 0, metadata !174), !dbg !175 ; [debug line = 126:9@102:9@57:2] [debug variable = resultAmplitude]
  %wait_load = load i1* @wait, align 1            ; [#uses=2 type=i1]
  %tmp_11 = add nsw i32 1, %sustainTime_load_tmp, !dbg !154 ; [#uses=1 type=i32] [debug line = 61:3]
  %tmp_12 = add nsw i32 1, %releaseTime_load_rel, !dbg !152 ; [#uses=2 type=i32] [debug line = 62:3]
  %releaseTime_new_1 = select i1 %tmp_s, i32 %releaseDuration_read, i32 %tmp_12 ; [#uses=1 type=i32]
  %releaseTime_loc_1 = select i1 %tmp_s, i32 %releaseTime_load, i32 %tmp_12 ; [#uses=1 type=i32]
  %sustainTime_new_1 = select i1 %tmp_s, i32 %sustainTime_load, i32 %tmp_11 ; [#uses=1 type=i32]
  %not_tmp_s = xor i1 %tmp_s, true                ; [#uses=2 type=i1]
  %tmp_32 = xor i1 %wait_load, true, !dbg !176    ; [#uses=1 type=i1] [debug line = 65:2]
  %tmp_13 = or i1 %tmp_32, %not_tmp_s, !dbg !176  ; [#uses=4 type=i1] [debug line = 65:2]
  %time_load = load i32* @time, align 4, !dbg !177 ; [#uses=1 type=i32] [debug line = 71:2]
  %tmp_33 = trunc i32 %press_read to i1           ; [#uses=1 type=i1]
  %tmp_34 = or i1 %tmp_33, %wait_load             ; [#uses=1 type=i1]
  %tmp_35 = call i31 @_ssdm_op_PartSelect.i31.i32.i32.i32(i32 %press_read, i32 1, i32 31) ; [#uses=1 type=i31]
  %tmp_36 = call i32 @_ssdm_op_BitConcatenate.i32.i31.i1(i31 %tmp_35, i1 %tmp_34), !dbg !176 ; [#uses=1 type=i32] [debug line = 65:2]
  %releaseTime_flag_1_s = icmp eq i32 %tmp_36, 0, !dbg !176 ; [#uses=1 type=i1] [debug line = 65:2]
  %releaseTime_new_1_re = select i1 %tmp_13, i32 %releaseTime_new_1, i32 %releaseDuration_read, !dbg !176 ; [#uses=1 type=i32] [debug line = 65:2]
  %releaseTime_loc_1_re = select i1 %tmp_13, i32 %releaseTime_loc_1, i32 %releaseDuration_read, !dbg !176 ; [#uses=1 type=i32] [debug line = 65:2]
  %sustainTime_new_1_tm = select i1 %tmp_13, i32 %sustainTime_new_1, i32 %tmp_10, !dbg !176 ; [#uses=3 type=i32] [debug line = 65:2]
  %time_load_s = select i1 %tmp_13, i32 %time_load, i32 0, !dbg !176 ; [#uses=8 type=i32] [debug line = 65:2]
  %tmp_14 = icmp slt i32 %time_load_s, %attackDuration_read, !dbg !177 ; [#uses=4 type=i1] [debug line = 71:2]
...
._crit_edge8.new_ifconv:                          ; preds = %mergeST1, %._crit_edge_ifconv
  %tmp_15 = sitofp i32 %time_load_s to float, !dbg !178 ; [#uses=1 type=float] [debug line = 72:3]
  %tmp_16 = fmul float %attackSlope, %tmp_15, !dbg !178 ; [#uses=1 type=float] [debug line = 72:3]
  %resultAmplitude_1 = fmul float %tmp_38, %tmp_16, !dbg !178 ; [#uses=1 type=float] [debug line = 72:3]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_1}, i64 0, metadata !174), !dbg !178 ; [debug line = 72:3] [debug variable = resultAmplitude]
  %tmp_17 = icmp slt i32 %time_load_s, %decayDuration_read, !dbg !180 ; [#uses=2 type=i1] [debug line = 75:7]
  %tmp_18 = sub nsw i32 %time_load_s, %attackDuration_read, !dbg !181 ; [#uses=1 type=i32] [debug line = 76:3]
  %tmp_19 = sitofp i32 %tmp_18 to float, !dbg !181 ; [#uses=1 type=float] [debug line = 76:3]
  %tmp_20 = fmul float %decaySlope, %tmp_19, !dbg !181 ; [#uses=1 type=float] [debug line = 76:3]
  %tmp_21 = fadd float %tmp_20, 1.000000e+00, !dbg !181 ; [#uses=1 type=float] [debug line = 76:3]
  %resultAmplitude_2 = fmul float %tmp_38, %tmp_21, !dbg !181 ; [#uses=1 type=float] [debug line = 76:3]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_2}, i64 0, metadata !174), !dbg !181 ; [debug line = 76:3] [debug variable = resultAmplitude]
  %tmp_22 = icmp slt i32 %time_load_s, %sustainTime_new_1_tm, !dbg !183 ; [#uses=3 type=i1] [debug line = 79:7]
  %resultAmplitude_3 = fmul float %tmp_38, %sustainAmplitude_ass, !dbg !184 ; [#uses=1 type=float] [debug line = 80:3]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_3}, i64 0, metadata !174), !dbg !184 ; [debug line = 80:3] [debug variable = resultAmplitude]
  %tmp_23 = icmp slt i32 %time_load_s, %releaseTime_loc_1_re, !dbg !186 ; [#uses=2 type=i1] [debug line = 83:7]
  %tmp_24 = sub nsw i32 %time_load_s, %sustainTime_new_1_tm, !dbg !187 ; [#uses=1 type=i32] [debug line = 84:3]
  %tmp_25 = sitofp i32 %tmp_24 to float, !dbg !187 ; [#uses=1 type=float] [debug line = 84:3]
  %tmp_26 = fmul float %releaseSlope, %tmp_25, !dbg !187 ; [#uses=1 type=float] [debug line = 84:3]
  %tmp_27 = fadd float %tmp_26, %sustainAmplitude_ass, !dbg !187 ; [#uses=1 type=float] [debug line = 84:3]
  %resultAmplitude_4 = fmul float %tmp_38, %tmp_27, !dbg !187 ; [#uses=1 type=float] [debug line = 84:3]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_4}, i64 0, metadata !174), !dbg !187 ; [debug line = 84:3] [debug variable = resultAmplitude]
  %not_tmp_1 = xor i1 %tmp_14, true               ; [#uses=2 type=i1]
  %sel_tmp2 = and i1 %tmp_17, %not_tmp_1          ; [#uses=3 type=i1]
  %sel_tmp = xor i1 %sel_tmp2, %not_tmp_1         ; [#uses=1 type=i1]
  %sel_tmp6_demorgan = or i1 %tmp_14, %tmp_17     ; [#uses=3 type=i1]
  %tmp_22_not = xor i1 %tmp_22, true              ; [#uses=1 type=i1]
  %not_sel_tmp7 = or i1 %sel_tmp6_demorgan, %tmp_22_not ; [#uses=1 type=i1]
  %sel_tmp13_demorgan = or i1 %sel_tmp6_demorgan, %tmp_22 ; [#uses=2 type=i1]
  %tmp_23_not = xor i1 %tmp_23, true              ; [#uses=1 type=i1]
  %not_sel_tmp = or i1 %sel_tmp13_demorgan, %tmp_23_not ; [#uses=1 type=i1]
  %tmp1 = and i1 %not_sel_tmp7, %not_sel_tmp      ; [#uses=1 type=i1]
  %sel_tmp8 = and i1 %tmp1, %sel_tmp              ; [#uses=1 type=i1]
  %wait_flag_1 = or i1 %sel_tmp8, %not_tmp_s      ; [#uses=1 type=i1]
  %sel_tmp1 = xor i1 %sel_tmp6_demorgan, true     ; [#uses=1 type=i1]
  %sel_tmp3 = and i1 %tmp_22, %sel_tmp1           ; [#uses=2 type=i1]
  %sel_tmp4 = xor i1 %sel_tmp13_demorgan, true    ; [#uses=1 type=i1]
  %sel_tmp5 = and i1 %tmp_23, %sel_tmp4           ; [#uses=2 type=i1]
  %or_cond = or i1 %sel_tmp5, %sel_tmp3           ; [#uses=1 type=i1]
  %or_cond1 = or i1 %sel_tmp2, %tmp_14            ; [#uses=1 type=i1]
  %or_cond2 = or i1 %or_cond, %or_cond1           ; [#uses=1 type=i1]
  %not_or_cond = xor i1 %or_cond2, true           ; [#uses=1 type=i1]
  %resultAmplitude_5 = select i1 %tmp_14, float %resultAmplitude_1, float 0.000000e+00, !dbg !189 ; [#uses=1 type=float] [debug line = 145:31@106:9@94:2]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_5}, i64 0, metadata !174), !dbg !181 ; [debug line = 76:3] [debug variable = resultAmplitude]
  %resultAmplitude_6 = select i1 %sel_tmp2, float %resultAmplitude_2, float %resultAmplitude_5, !dbg !189 ; [#uses=1 type=float] [debug line = 145:31@106:9@94:2]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_6}, i64 0, metadata !174), !dbg !181 ; [debug line = 76:3] [debug variable = resultAmplitude]
  %resultAmplitude_7 = select i1 %sel_tmp3, float %resultAmplitude_3, float %resultAmplitude_6, !dbg !189 ; [#uses=1 type=float] [debug line = 145:31@106:9@94:2]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude_7}, i64 0, metadata !174), !dbg !181 ; [debug line = 76:3] [debug variable = resultAmplitude]
  %resultAmplitude = select i1 %sel_tmp5, float %resultAmplitude_4, float %resultAmplitude_7, !dbg !189 ; [#uses=1 type=float] [debug line = 145:31@106:9@94:2]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude}, i64 0, metadata !174), !dbg !181 ; [debug line = 76:3] [debug variable = resultAmplitude]
  %tmp_29 = add nsw i32 %time_load_s, 1, !dbg !196 ; [#uses=1 type=i32] [debug line = 92:2]
  call void @llvm.dbg.value(metadata !{float* %wave_out_V}, i64 0, metadata !197), !dbg !199 ; [debug line = 105:48@94:2] [debug variable = stream<float>.V]
  call void @llvm.dbg.value(metadata !{float* %wave_out_V}, i64 0, metadata !200), !dbg !202 ; [debug line = 144:48@106:9@94:2] [debug variable = stream<float>.V]
  call void @llvm.dbg.value(metadata !{float %resultAmplitude}, i64 0, metadata !203), !dbg !189 ; [debug line = 145:31@106:9@94:2] [debug variable = tmp]
  call void @_ssdm_op_Write.axis.volatile.floatP(float* %wave_out_V, float %resultAmplitude), !dbg !204 ; [debug line = 146:9@106:9@94:2]
  store i32 %tmp_29, i32* @time, align 4, !dbg !205 ; [debug line = 66:3]
  br i1 %wait_flag_1, label %mergeST3, label %.new

mergeST1:                                         ; preds = %._crit_edge_ifconv
  store i32 %sustainTime_new_1_tm, i32* @sustainTime, align 4, !dbg !155 ; [debug line = 49:3]
  store i32 %releaseTime_new_1_re, i32* @releaseTime, align 4, !dbg !207 ; [debug line = 48:3]
  br label %._crit_edge8.new_ifconv

mergeST3:                                         ; preds = %._crit_edge8.new_ifconv
  store i1 %not_or_cond, i1* @wait, align 1, !dbg !208 ; [debug line = 60:3]
  br label %.new

.new:                                             ; preds = %mergeST3, %._crit_edge8.new_ifconv
  ret void, !dbg !209                             ; [debug line = 95:1]
}
...
entry:
  ...
  %empty_7 = zext i1 %1 to i32                    ; [#uses=1 type=i32]
  %empty_8 = shl i32 %empty, 1                    ; [#uses=1 type=i32]
...
!148 = metadata !{i32 36, i32 82, metadata !136, null}
!149 = metadata !{i32 786688, metadata !136, metadata !"releaseSlope", metadata !54, i32 36, metadata !63, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!150 = metadata !{i32 40, i32 2, metadata !136, null}
!151 = metadata !{i32 47, i32 2, metadata !136, null}
!152 = metadata !{i32 62, i32 3, metadata !153, null}
!153 = metadata !{i32 786443, metadata !136, i32 59, i32 16, metadata !54, i32 2} ; [ DW_TAG_lexical_block ]
!154 = metadata !{i32 61, i32 3, metadata !153, null}
!155 = metadata !{i32 49, i32 3, metadata !156, null}
!156 = metadata !{i32 786443, metadata !136, i32 47, i32 36, metadata !54, i32 1} ; [ DW_TAG_lexical_block ]
!157 = metadata !{i32 52, i32 2, metadata !136, null}
...
!164 = metadata !{i32 57, i32 2, metadata !136, null}
...
!176 = metadata !{i32 65, i32 2, metadata !136, null}
!177 = metadata !{i32 71, i32 2, metadata !136, null}
!178 = metadata !{i32 72, i32 3, metadata !179, null}
!179 = metadata !{i32 786443, metadata !136, i32 71, i32 27, metadata !54, i32 4} ; [ DW_TAG_lexical_block ]
!180 = metadata !{i32 75, i32 7, metadata !136, null}
!181 = metadata !{i32 76, i32 3, metadata !182, null}
!182 = metadata !{i32 786443, metadata !136, i32 75, i32 31, metadata !54, i32 5} ; [ DW_TAG_lexical_block ]
!183 = metadata !{i32 79, i32 7, metadata !136, null}
!184 = metadata !{i32 80, i32 3, metadata !185, null}
!185 = metadata !{i32 786443, metadata !136, i32 79, i32 30, metadata !54, i32 6} ; [ DW_TAG_lexical_block ]
!186 = metadata !{i32 83, i32 7, metadata !136, null}
!187 = metadata !{i32 84, i32 3, metadata !188, null}
!188 = metadata !{i32 786443, metadata !136, i32 83, i32 29, metadata !54, i32 7} ; [ DW_TAG_lexical_block ]
!189 = metadata !{i32 145, i32 31, metadata !190, metadata !192}
!190 = metadata !{i32 786443, metadata !191, i32 144, i32 79, metadata !60, i32 10} ; [ DW_TAG_lexical_block ]
!191 = metadata !{i32 786478, i32 0, metadata !59, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamIfE5writeERKf", metadata !60, i32 144, metadata !89, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !106, metadata !68, i32 144} ; [ DW_TAG_subprogram ]
!192 = metadata !{i32 106, i32 9, metadata !193, metadata !195}
!193 = metadata !{i32 786443, metadata !194, i32 105, i32 88, metadata !60, i32 9} ; [ DW_TAG_lexical_block ]
!194 = metadata !{i32 786478, i32 0, metadata !59, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls6streamIfElsERKf", metadata !60, i32 105, metadata !89, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !88, metadata !68, i32 105} ; [ DW_TAG_subprogram ]
!195 = metadata !{i32 94, i32 2, metadata !136, null}
!196 = metadata !{i32 92, i32 2, metadata !136, null}
!197 = metadata !{i32 790531, metadata !198, metadata !"stream<float>.V", null, i32 105, metadata !162, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!198 = metadata !{i32 786689, metadata !194, metadata !"this", metadata !60, i32 16777321, metadata !161, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!199 = metadata !{i32 105, i32 48, metadata !194, metadata !195}
!200 = metadata !{i32 790531, metadata !201, metadata !"stream<float>.V", null, i32 144, metadata !162, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!201 = metadata !{i32 786689, metadata !191, metadata !"this", metadata !60, i32 16777360, metadata !161, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!202 = metadata !{i32 144, i32 48, metadata !191, metadata !192}
!203 = metadata !{i32 786688, metadata !190, metadata !"tmp", metadata !60, i32 145, metadata !63, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!204 = metadata !{i32 146, i32 9, metadata !190, metadata !192}
!205 = metadata !{i32 66, i32 3, metadata !206, null}
!206 = metadata !{i32 786443, metadata !136, i32 65, i32 10, metadata !54, i32 3} ; [ DW_TAG_lexical_block ]
!207 = metadata !{i32 48, i32 3, metadata !156, null}
!208 = metadata !{i32 60, i32 3, metadata !153, null}
!209 = metadata !{i32 95, i32 1, metadata !136, null}
