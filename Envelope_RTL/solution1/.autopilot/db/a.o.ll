; ModuleID = '/home/austin/ECE1373_GhostSynth/modules/Envelope/Envelope_RTL/solution1/.autopilot/db/a.o.bc'
...
@_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time = internal global i32 0, align 4 ; [#uses=11 type=i32*]
...
@_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11sustainTime = internal global i32 0, align 4 ; [#uses=5 type=i32*]
...
; <label>:61                                      ; preds = %57
  ...
  br label %62, !dbg !148                         ; [debug line = 48:3]

; <label>:62                                      ; preds = %61, %57
  %63 = load i32* %3, align 4, !dbg !149          ; [#uses=1 type=i32] [debug line = 50:2]
  %64 = icmp sge i32 %63, 1, !dbg !149            ; [#uses=1 type=i1] [debug line = 50:2]
  br i1 %64, label %65, label %74, !dbg !149      ; [debug line = 50:2]

; <label>:65                                      ; preds = %62
  %66 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !149 ; [#uses=1 type=i32] [debug line = 50:2]
  %67 = load i32* %5, align 4, !dbg !149          ; [#uses=1 type=i32] [debug line = 50:2]
  %68 = icmp sgt i32 %66, %67, !dbg !149          ; [#uses=1 type=i1] [debug line = 50:2]
  br i1 %68, label %69, label %74, !dbg !149      ; [debug line = 50:2]

; <label>:69                                      ; preds = %65
  %70 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11sustainTime, align 4, !dbg !150 ; [#uses=1 type=i32] [debug line = 51:3]
  %71 = add nsw i32 %70, 1, !dbg !150             ; [#uses=1 type=i32] [debug line = 51:3]
  store i32 %71, i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11sustainTime, align 4, !dbg !150 ; [debug line = 51:3]
  %72 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11releaseTime, align 4, !dbg !152 ; [#uses=1 type=i32] [debug line = 52:3]
  %73 = add nsw i32 %72, 1, !dbg !152             ; [#uses=1 type=i32] [debug line = 52:3]
  store i32 %73, i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11releaseTime, align 4, !dbg !152 ; [debug line = 52:3]
  br label %74, !dbg !153                         ; [debug line = 53:2]

; <label>:74                                      ; preds = %69, %65, %62
  %75 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4wait, align 4, !dbg !154 ; [#uses=1 type=i32] [debug line = 55:2]
  %76 = icmp ne i32 %75, 0, !dbg !154             ; [#uses=1 type=i1] [debug line = 55:2]
  br i1 %76, label %77, label %78, !dbg !154      ; [debug line = 55:2]

; <label>:77                                      ; preds = %74
  store i32 0, i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !155 ; [debug line = 56:3]
  br label %78, !dbg !157                         ; [debug line = 57:2]

; <label>:78                                      ; preds = %77, %74
  %79 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !158 ; [#uses=1 type=i32] [debug line = 59:2]
  %80 = load i32* %4, align 4, !dbg !158          ; [#uses=1 type=i32] [debug line = 59:2]
  %81 = icmp slt i32 %79, %80, !dbg !158          ; [#uses=1 type=i1] [debug line = 59:2]
  br i1 %81, label %82, label %89, !dbg !158      ; [debug line = 59:2]

; <label>:82                                      ; preds = %78
  %83 = load float* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11attackSlope, align 4, !dbg !159 ; [#uses=1 type=float] [debug line = 60:3]
  %84 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !159 ; [#uses=1 type=i32] [debug line = 60:3]
  %85 = sitofp i32 %84 to float, !dbg !159        ; [#uses=1 type=float] [debug line = 60:3]
  %86 = fmul float %83, %85, !dbg !159            ; [#uses=1 type=float] [debug line = 60:3]
  %87 = load float* %resultAmplitude, align 4, !dbg !159 ; [#uses=1 type=float] [debug line = 60:3]
  %88 = fmul float %87, %86, !dbg !159            ; [#uses=1 type=float] [debug line = 60:3]
  store float %88, float* %resultAmplitude, align 4, !dbg !159 ; [debug line = 60:3]
  br label %132, !dbg !161                        ; [debug line = 61:2]

; <label>:89                                      ; preds = %78
  %90 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !162 ; [#uses=1 type=i32] [debug line = 63:7]
  %91 = load i32* %5, align 4, !dbg !162          ; [#uses=1 type=i32] [debug line = 63:7]
  %92 = icmp slt i32 %90, %91, !dbg !162          ; [#uses=1 type=i1] [debug line = 63:7]
  br i1 %92, label %93, label %103, !dbg !162     ; [debug line = 63:7]

; <label>:93                                      ; preds = %89
  %94 = load float* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE10decaySlope, align 4, !dbg !163 ; [#uses=1 type=float] [debug line = 64:3]
  %95 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !163 ; [#uses=1 type=i32] [debug line = 64:3]
  %96 = load i32* %4, align 4, !dbg !163          ; [#uses=1 type=i32] [debug line = 64:3]
  %97 = sub nsw i32 %95, %96, !dbg !163           ; [#uses=1 type=i32] [debug line = 64:3]
  %98 = sitofp i32 %97 to float, !dbg !163        ; [#uses=1 type=float] [debug line = 64:3]
  %99 = fmul float %94, %98, !dbg !163            ; [#uses=1 type=float] [debug line = 64:3]
  %100 = fadd float %99, 2.000000e+00, !dbg !163  ; [#uses=1 type=float] [debug line = 64:3]
  %101 = load float* %resultAmplitude, align 4, !dbg !163 ; [#uses=1 type=float] [debug line = 64:3]
  %102 = fmul float %101, %100, !dbg !163         ; [#uses=1 type=float] [debug line = 64:3]
  store float %102, float* %resultAmplitude, align 4, !dbg !163 ; [debug line = 64:3]
  br label %131, !dbg !165                        ; [debug line = 65:2]

; <label>:103                                     ; preds = %89
  %104 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !166 ; [#uses=1 type=i32] [debug line = 67:7]
  %105 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11sustainTime, align 4, !dbg !166 ; [#uses=1 type=i32] [debug line = 67:7]
  %106 = icmp slt i32 %104, %105, !dbg !166       ; [#uses=1 type=i1] [debug line = 67:7]
  br i1 %106, label %107, label %112, !dbg !166   ; [debug line = 67:7]

; <label>:107                                     ; preds = %103
  %108 = load i32* %6, align 4, !dbg !167         ; [#uses=1 type=i32] [debug line = 68:3]
  %109 = sitofp i32 %108 to float, !dbg !167      ; [#uses=1 type=float] [debug line = 68:3]
  %110 = load float* %resultAmplitude, align 4, !dbg !167 ; [#uses=1 type=float] [debug line = 68:3]
  %111 = fmul float %110, %109, !dbg !167         ; [#uses=1 type=float] [debug line = 68:3]
  store float %111, float* %resultAmplitude, align 4, !dbg !167 ; [debug line = 68:3]
  br label %130, !dbg !169                        ; [debug line = 69:2]

; <label>:112                                     ; preds = %103
  %113 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !170 ; [#uses=1 type=i32] [debug line = 71:7]
  %114 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11releaseTime, align 4, !dbg !170 ; [#uses=1 type=i32] [debug line = 71:7]
  %115 = icmp slt i32 %113, %114, !dbg !170       ; [#uses=1 type=i1] [debug line = 71:7]
  br i1 %115, label %116, label %128, !dbg !170   ; [debug line = 71:7]

; <label>:116                                     ; preds = %112
  %117 = load float* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE12releaseSlope, align 4, !dbg !171 ; [#uses=1 type=float] [debug line = 72:3]
  %118 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !171 ; [#uses=1 type=i32] [debug line = 72:3]
  %119 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE11sustainTime, align 4, !dbg !171 ; [#uses=1 type=i32] [debug line = 72:3]
  %120 = sub nsw i32 %118, %119, !dbg !171        ; [#uses=1 type=i32] [debug line = 72:3]
  %121 = sitofp i32 %120 to float, !dbg !171      ; [#uses=1 type=float] [debug line = 72:3]
  %122 = fmul float %117, %121, !dbg !171         ; [#uses=1 type=float] [debug line = 72:3]
  %123 = load i32* %6, align 4, !dbg !171         ; [#uses=1 type=i32] [debug line = 72:3]
  %124 = sitofp i32 %123 to float, !dbg !171      ; [#uses=1 type=float] [debug line = 72:3]
  %125 = fadd float %122, %124, !dbg !171         ; [#uses=1 type=float] [debug line = 72:3]
  %126 = load float* %resultAmplitude, align 4, !dbg !171 ; [#uses=1 type=float] [debug line = 72:3]
  %127 = fmul float %126, %125, !dbg !171         ; [#uses=1 type=float] [debug line = 72:3]
  store float %127, float* %resultAmplitude, align 4, !dbg !171 ; [debug line = 72:3]
  br label %129, !dbg !173                        ; [debug line = 73:2]

; <label>:128                                     ; preds = %112
  store float 0.000000e+00, float* %resultAmplitude, align 4, !dbg !174 ; [debug line = 76:3]
  store i32 1, i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4wait, align 4, !dbg !176 ; [debug line = 77:3]
  br label %129
...
; <label>:132                                     ; preds = %131, %82
  %133 = load i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !177 ; [#uses=1 type=i32] [debug line = 80:2]
  %134 = add nsw i32 %133, 1, !dbg !177           ; [#uses=1 type=i32] [debug line = 80:2]
  store i32 %134, i32* @_ZZ8envelopeRN3hls6streamIfEES2_iiiiiiE4time, align 4, !dbg !177 ; [debug line = 80:2]
  %135 = load %"class.hls::stream"** %2, align 8, !dbg !178 ; [#uses=1 type=%"class.hls::stream"*] [debug line = 82:2]
  call void @_ZN3hls6streamIfElsERKf(%"class.hls::stream"* %135, float* %resultAmplitude), !dbg !178 ; [debug line = 82:2]
  ret void, !dbg !179                             ; [debug line = 83:1]
}
...
!149 = metadata !{i32 50, i32 2, metadata !129, null}
!150 = metadata !{i32 51, i32 3, metadata !151, null}
!151 = metadata !{i32 786443, metadata !129, i32 50, i32 40, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!152 = metadata !{i32 52, i32 3, metadata !151, null}
!153 = metadata !{i32 53, i32 2, metadata !151, null}
!154 = metadata !{i32 55, i32 2, metadata !129, null}
!155 = metadata !{i32 56, i32 3, metadata !156, null}
!156 = metadata !{i32 786443, metadata !129, i32 55, i32 10, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!157 = metadata !{i32 57, i32 2, metadata !156, null}
!158 = metadata !{i32 59, i32 2, metadata !129, null}
!159 = metadata !{i32 60, i32 3, metadata !160, null}
!160 = metadata !{i32 786443, metadata !129, i32 59, i32 27, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!161 = metadata !{i32 61, i32 2, metadata !160, null}
!162 = metadata !{i32 63, i32 7, metadata !129, null}
!163 = metadata !{i32 64, i32 3, metadata !164, null}
!164 = metadata !{i32 786443, metadata !129, i32 63, i32 31, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!165 = metadata !{i32 65, i32 2, metadata !164, null}
!166 = metadata !{i32 67, i32 7, metadata !129, null}
!167 = metadata !{i32 68, i32 3, metadata !168, null}
!168 = metadata !{i32 786443, metadata !129, i32 67, i32 30, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!169 = metadata !{i32 69, i32 2, metadata !168, null}
!170 = metadata !{i32 71, i32 7, metadata !129, null}
!171 = metadata !{i32 72, i32 3, metadata !172, null}
!172 = metadata !{i32 786443, metadata !129, i32 71, i32 29, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!173 = metadata !{i32 73, i32 2, metadata !172, null}
!174 = metadata !{i32 76, i32 3, metadata !175, null}
!175 = metadata !{i32 786443, metadata !129, i32 75, i32 7, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!176 = metadata !{i32 77, i32 3, metadata !175, null}
!177 = metadata !{i32 80, i32 2, metadata !129, null}
!178 = metadata !{i32 82, i32 2, metadata !129, null}
!179 = metadata !{i32 83, i32 1, metadata !129, null}
