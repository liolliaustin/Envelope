...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler envelope_CTRL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { wave_in_V_TDATA { I 32 vector } wave_in_V_TVALID { I 1 bit } wave_in_V_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'wave_in_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { wave_out_V_TDATA { O 32 vector } wave_out_V_TVALID { O 1 bit } wave_out_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'wave_out_V'"
}
}
