...
entity envelope_CTRL_BUS_s_axi is
generic (
...
architecture behave of envelope_CTRL_BUS_s_axi is
    ...
    constant ADDR_ATTACKDURATION_DATA_0   : INTEGER := 16#18#;
    constant ADDR_ATTACKDURATION_CTRL     : INTEGER := 16#1c#;
    constant ADDR_DECAYDURATION_DATA_0    : INTEGER := 16#20#;
